...
bool compute_numeric_element(struct numeric_array *, unsigned dimensions, unsigned indexes[], double* *addr);
...
bool compute_string_element(struct string_array *, unsigned dimensions, unsigned indexes[], char* * *addr);
